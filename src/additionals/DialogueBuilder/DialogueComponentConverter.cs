    ...
    internal class DialogueComponentConverter
    {
        ...
        private sealed class ConditionMap
        {
            private static readonly Dictionary<DialogueCondition, IConditionDescription?> map = new()
            {
                ...
                { DialogueCondition.DC_IS_PLAYER, new BooleanDescription("{0} belongs to the player squad", "{0} does not belong to the player squad") },
                ...
                { DialogueCondition.DC_IN_COMBAT, new BooleanDescription("{0} is in combat", "{0} is not in combat") },
                { DialogueCondition.DC_WITHIN_TOWN_WALLS, null },
                { DialogueCondition.DC_TOWN_WALLS_LOCKED_UP, null },
                { DialogueCondition.DC_IS_SLAVE, new BooleanDescription("{0} is enslaved", "{0} is not enslaved") },
                ...
                { DialogueCondition.DC_IS_RECRUITABLE, new BooleanDescription("{0} is [[Playable Characters#'Is Recruitable' Tag|recruitable]] (TODO)", "{0} is not [[Playable Characters#'Is Recruitable' Tag|recruitable]] (TODO)") },
        ...
        private sealed class EffectMap
        {
            private static readonly Dictionary<DialogueEffect, IEffectDescription?> map = new()
            {
                ...
                { DialogueEffect.DA_ATTACK_CHASE_FOREVER, new EffectDescription("{0} aggressively chases the target") },
                ...
                { DialogueEffect.DA_FORCE_SPEECH_TIMER, new EffectDescription("{0}'s last spoken line is set to last for {1} seconds") },
                { DialogueEffect.DA_DECLARE_WAR, null },
                { DialogueEffect.DA_END_WAR, null },
                { DialogueEffect.DA_CLEAR_AI, new EffectDescription("{0} returns to normal (TODO I guess)") },
                { DialogueEffect.DA_FOLLOW_WHILE_TALKING, new EffectDescription("{0} follows the target") },
                ...
                { DialogueEffect.DA_FLAG_TEMP_ALLY, new EffectDescription("{0} temporarily becomes an ally to the target") },
                { DialogueEffect.DA_FLAG_TEMP_ENEMY, new EffectDescription("{0} temporarily becomes an enemy to the target") },
                ...
                { DialogueEffect.DA_RUN_AWAY, new EffectDescription("{0} starts running away") },
                ...
                { DialogueEffect.DA_KNOCKOUT, new EffectDescription("{0} falls unconscious for {1} seconds") },
